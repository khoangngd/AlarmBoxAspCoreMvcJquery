...
using ZeroDemo.MultiTenancy.Demo;
...
namespace ZeroDemo.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(ZeroDemoConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(ZeroDemoConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
