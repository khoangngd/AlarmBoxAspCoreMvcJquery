...
{
    public class StripeGatewayManager : ZeroDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "ZeroDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + ZeroDemoConsts.Currency;
        }
        ...
        private async Task<StripeIdResponse> CreatePlanAsync(string planId, decimal amount, string interval, string productId)
        {
            ...
            var plan = await planService.CreateAsync(new PlanCreateOptions
            {
                ...
                Interval = interval,
                Product = productId,
                Currency = ZeroDemoConsts.Currency
            });
