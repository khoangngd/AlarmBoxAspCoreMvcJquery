...
using ZeroDemo.Authorization.Ldap;
using ZeroDemo.Authorization.Roles;
using ZeroDemo.Authorization.Users;
using ZeroDemo.Chat;
using ZeroDemo.Configuration;
using ZeroDemo.DashboardCustomization.Definitions;
using ZeroDemo.Debugging;
using ZeroDemo.DynamicEntityProperties;
using ZeroDemo.Features;
using ZeroDemo.Friendships;
using ZeroDemo.Friendships.Cache;
using ZeroDemo.Localization;
using ZeroDemo.MultiTenancy;
using ZeroDemo.Net.Emailing;
using ZeroDemo.Notifications;
using ZeroDemo.WebHooks;

namespace ZeroDemo
{
    [DependsOn(
        typeof(ZeroDemoCoreSharedModule),
    ...
    public class ZeroDemoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            ZeroDemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = ZeroDemoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, ZeroDemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<ZeroDemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ZeroDemoCoreModule).GetAssembly());
        }
