...
namespace ZeroDemo.Web.Public.Startup
{
    [DependsOn(
        typeof(ZeroDemoWebCoreModule)
    )]
    public class ZeroDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public ZeroDemoWebFrontEndModule(IWebHostEnvironment env, ZeroDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ZeroDemoWebFrontEndModule).GetAssembly());
        }
    }
}
