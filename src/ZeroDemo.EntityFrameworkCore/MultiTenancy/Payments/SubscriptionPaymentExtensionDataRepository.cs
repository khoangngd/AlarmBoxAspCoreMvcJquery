...
using ZeroDemo.EntityFrameworkCore.Repositories;

namespace ZeroDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : ZeroDemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<ZeroDemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
