...
{
    public class SubscriptionPaymentRepository : ZeroDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<ZeroDemoDbContext> dbContextProvider)
