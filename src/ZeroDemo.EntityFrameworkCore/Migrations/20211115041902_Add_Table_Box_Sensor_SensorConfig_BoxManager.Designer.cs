...
namespace ZeroDemo.Migrations
{
    ...
    [Migration("20211115041902_Add_Table_Box_Sensor_SensorConfig_BoxManager")]
    partial class Add_Table_Box_Sensor_SensorConfig_BoxManager
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZeroDemo.AlarmBox.BoxManagers.BoxManager", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("App_BoxManagers");
                });

            modelBuilder.Entity("ZeroDemo.AlarmBox.Boxes.Box", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<int>("MaxBoxManagerPort")
                        .HasColumnType("int");

                    b.Property<int>("MaxBoxPort")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ZeroDemo.AlarmBox.SensorConfigs.SensorConfig", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("InrangeColor")
                        .HasColumnType("nvarchar(128)")
                        .HasMaxLength(128);
                    ...
                    b.Property<string>("OutrangeColor")
                        .HasColumnType("nvarchar(128)")
                        .HasMaxLength(128);
                    ...
                    b.ToTable("App_SensorConfigs");
                });

            modelBuilder.Entity("ZeroDemo.AlarmBox.Sensors.Sensor", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<double>("HighValueDefault")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("LowValueDefault")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("TargetValueDefault")
                        .HasColumnType("float");

                    b.HasKey("Id");

                    b.ToTable("App_Sensors");
                });

            modelBuilder.Entity("ZeroDemo.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ZeroDemo.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ZeroDemo.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ZeroDemo.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ZeroDemo.AlarmBox.BoxManagers.BoxManager", b =>
                {
                    b.HasOne("ZeroDemo.AlarmBox.Boxes.Box", "Box")
                        .WithMany("BoxManagers")
                        .HasForeignKey("BoxId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ZeroDemo.AlarmBox.SensorConfigs.SensorConfig", b =>
                {
                    ...
                    b.HasOne("ZeroDemo.AlarmBox.Sensors.Sensor", "Sensor")
                        .WithMany("SensorConfigs")
