...
using ZeroDemo.Core.Base;
using ZeroDemo.Core.Extensions;
using ZeroDemo.Dto;
using ZeroDemo.Types;

namespace ZeroDemo.Queries
{
    public class OrganizationUnitQuery : ZeroDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
