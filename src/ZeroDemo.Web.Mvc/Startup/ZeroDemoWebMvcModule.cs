...
namespace ZeroDemo.Web.Startup
{
    ...
    public class ZeroDemoWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public ZeroDemoWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ZeroDemoWebMvcModule).GetAssembly());
        }
