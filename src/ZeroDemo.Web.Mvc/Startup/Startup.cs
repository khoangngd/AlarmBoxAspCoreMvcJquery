...
using ZeroDemo.Identity;
using ZeroDemo.Schemas;
using ZeroDemo.Web.Chat.SignalR;
using ZeroDemo.Web.Common;
using ZeroDemo.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using ZeroDemo.Web.IdentityServer;
using ZeroDemo.Web.Swagger;
using Stripe;
...
using ZeroDemo.Web.HealthCheck;
using Owl.reCAPTCHA;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerDoc("v1", new OpenApiInfo() { Title = "ZeroDemo API", Version = "v1" });
            ...
            return services.AddAbp<ZeroDemoWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "ZeroDemo API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("ZeroDemo.Web.wwwroot.swagger.ui.index.html");
