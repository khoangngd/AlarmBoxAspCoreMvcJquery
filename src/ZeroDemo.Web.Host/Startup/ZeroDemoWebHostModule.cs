...
using ZeroDemo.Web.Startup.ExternalLoginInfoProviders;
...
namespace ZeroDemo.Web.Startup
{
    ...
    public class ZeroDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ZeroDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ZeroDemoWebHostModule).GetAssembly());
        }
