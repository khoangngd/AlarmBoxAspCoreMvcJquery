...
using ZeroDemo.Authorization.Users.Profile.Dto;
using ZeroDemo.Commands;
using ZeroDemo.Core.Threading;
using ZeroDemo.Models.NavigationMenu;
using ZeroDemo.Services.Navigation;
using ZeroDemo.ViewModels.Base;
using Plugin.Media;
...
using ZeroDemo.ApiClient;
using ZeroDemo.Controls;
using ZeroDemo.Dto;
using ZeroDemo.Extensions;
using ZeroDemo.Localization;
using ZeroDemo.UI;
using ZeroDemo.UI.Assets;
using ZeroDemo.Views;
using DependencyResolver = ZeroDemo.Core.Dependency.DependencyResolver;

namespace ZeroDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "ZeroDemo";
