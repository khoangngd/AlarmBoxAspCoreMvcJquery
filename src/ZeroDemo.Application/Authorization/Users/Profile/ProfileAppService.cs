...
using ZeroDemo.Authorization.Users.Profile.Cache;
...
using ZeroDemo.Timing;

namespace ZeroDemo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : ZeroDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("ZeroDemo",
