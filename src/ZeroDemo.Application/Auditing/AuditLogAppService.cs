...
using ZeroDemo.Auditing.Exporting;
using ZeroDemo.Authorization;
using ZeroDemo.Authorization.Users;
using ZeroDemo.Dto;
using ZeroDemo.EntityHistory;
using EntityHistoryHelper = ZeroDemo.EntityHistory.EntityHistoryHelper;

namespace ZeroDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : ZeroDemoAppServiceBase, IAuditLogAppService
    {
