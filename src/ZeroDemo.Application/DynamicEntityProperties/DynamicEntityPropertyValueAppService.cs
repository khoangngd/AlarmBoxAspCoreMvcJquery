...
using ZeroDemo.DynamicEntityPropertyValues.Dto;

namespace ZeroDemo.DynamicEntityProperties
{
    [Authorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : ZeroDemoAppServiceBase, IDynamicEntityPropertyValueAppService
    {
