...
using ZeroDemo.Migrations.Seed.Host;
...
namespace ZeroDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ZeroDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ZeroDemoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{ZeroDemoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{ZeroDemoConsts.ConnectionStringName}", constring);
        }
