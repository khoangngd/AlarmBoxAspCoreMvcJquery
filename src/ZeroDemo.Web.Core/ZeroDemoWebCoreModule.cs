...
using ZeroDemo.Web.Authentication.JwtBearer;
using ZeroDemo.Web.Authentication.TwoFactor;
using ZeroDemo.Web.Chat.SignalR;
using ZeroDemo.Web.Configuration;
using ZeroDemo.Web.DashboardCustomization;

namespace ZeroDemo.Web
{
    [DependsOn(
        typeof(ZeroDemoApplicationModule),
        typeof(ZeroDemoEntityFrameworkCoreModule),
    ...
    public class ZeroDemoWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ZeroDemoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(ZeroDemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ZeroDemoWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(ZeroDemoWebCoreModule).Assembly);
        }
