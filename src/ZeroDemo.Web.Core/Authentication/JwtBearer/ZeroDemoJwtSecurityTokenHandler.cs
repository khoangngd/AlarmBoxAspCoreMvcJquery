...
namespace ZeroDemo.Web.Authentication.JwtBearer
{
    public class ZeroDemoJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public ZeroDemoJwtSecurityTokenHandler()
        {
