...
using ZeroDemo.MultiTenancy.HostDashboard;
...
namespace ZeroDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ZeroDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
